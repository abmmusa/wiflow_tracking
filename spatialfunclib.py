...
def angle_difference(bearing_a, bearing_b):
    """ Computes the absolute difference in angle between two bearings in degrees. Tricky bit being that 359 and 1 degrees are 2 degrees apart."""
    diff = abs(bearing_a-bearing_b)
    if abs(360-diff)<diff: return 360-diff
    else: return diff
